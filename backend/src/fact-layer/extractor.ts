...
const PARSE_STD_INCOME_RULES = (idx: number, period_path: string): ExtractionRule[] => ([
  { fact_key: 'revenue',           json_path: `standardized_statements[${idx}].income_statement.revenue`,           unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'cost_of_sales',     json_path: `standardized_statements[${idx}].income_statement.cost_of_sales`,     unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'gross_profit',      json_path: `standardized_statements[${idx}].income_statement.gross_profit`,      unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'operating_income',  json_path: `standardized_statements[${idx}].income_statement.operating_income`,  unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'ebitda',            json_path: `standardized_statements[${idx}].income_statement.ebitda`,            unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'net_income',        json_path: `standardized_statements[${idx}].income_statement.net_income`,        unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
]);

const PARSE_STD_BALANCE_RULES = (idx: number, period_path: string): ExtractionRule[] => ([
  { fact_key: 'total_assets',         json_path: `standardized_statements[${idx}].balance_sheet.total_assets`,         unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'total_equity',         json_path: `standardized_statements[${idx}].balance_sheet.total_equity`,         unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
  { fact_key: 'current_liabilities',  json_path: `standardized_statements[${idx}].balance_sheet.current_liabilities`,  unit: 'TRY', period_scope: 'per_period', period_path, computation_complexity: 0 },
]);
...
const FINANCIAL_ANALYSIS_RULES: ExtractionRule[] = [
  { fact_key: 'revenue',            json_path: 'canonical_numbers.revenue',            unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 0 },
  { fact_key: 'net_income',         json_path: 'canonical_numbers.net_income',         unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 0 },
  { fact_key: 'total_assets',       json_path: 'canonical_numbers.total_assets',       unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 0 },
  { fact_key: 'total_equity',       json_path: 'canonical_numbers.total_equity',       unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 0 },
  { fact_key: 'gross_margin',       json_path: 'canonical_numbers.gross_margin',       unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'ebitda_margin',      json_path: 'canonical_numbers.ebitda_margin',      unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'net_margin',         json_path: 'canonical_numbers.net_margin',         unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'roe',                json_path: 'canonical_numbers.roe',                unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'roa',                json_path: 'canonical_numbers.roa',                unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'roce',               json_path: 'canonical_numbers.roce',               unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'current_ratio',      json_path: 'canonical_numbers.current_ratio',      unit: 'decimal', period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'net_debt',           json_path: 'canonical_numbers.net_debt',           unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
  { fact_key: 'net_debt_to_ebitda', json_path: 'canonical_numbers.net_debt_to_ebitda', unit: 'x',       period_scope: 'per_period', period_path: 'period_label', computation_complexity: 2 },
  { fact_key: 'fcf',                json_path: 'canonical_numbers.fcf',                unit: 'TRY',     period_scope: 'per_period', period_path: 'period_label', computation_complexity: 1 },
];
