...
1. **financial_analysis output**: FCF, growth rates, WACC components (risk-free rate, equity risk premium), FAVÖK, net kar, temettü verileri, ROE, ROCE
2. **market_data**: Güncel hisse fiyatı, toplam hisse sayısı, piyasa değeri, firma değeri (EV)
3. **context_extraction output**: İş modeli, holding flag, segment bilgisi, temettü politikası
