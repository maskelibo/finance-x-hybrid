# ESG Agent — Katman 2b: Vaka Bazlı Dersler
...
- **Yeni CEO/Chairman sonrası governance skoru güncellenmedi** — 10 Nisan 2026 liderlik değişikliği G boyutunu etkiliyor; dualite riski var mı? Bu değişiklik ESG G puanına yansıtılmadı.
...
- **Yönetim değişikliğini G skoruna yansıt** — CEO/Chairman değişikliği governance disruptif event; geçiş döneminde G puanı geçici baskı alır.
- **"Not Disclosed" yerine "IATA/ICAO public tracker'dan ara"** — Büyük havayolları için sektör örgütlerinin kamuya açık veritabanları zorunlu kaynak.
...
- **CDP kaydı kontrol edildi mi?** — BIST Sürdürülebilirlik Endeksi üyeliği teyit edildi ✓; ancak CDP kayıt durumu raporda belirtilmedi.
- **TSRS uyum durumu kontrol edilmedi** — KAP'ta TFRS-S1/S2 uyum beyanı var mı? SPK 2024+ için zorunlu hale getirdi.
- **CEO dualitesi (Topbaş hem Chairman hem CEO interim)** — Bu G boyutunda en kritik risk; SPK best practice ihlali.
- **3 ana risk iyi tespit edildi ✓** — Tedarik zinciri gıda güvenliği, CEO geçişi, çalışan metrikleri.
- **FTSE4Good dahilliği teyit edildi ✓**

### Bundan Sonra:
- **Perakende sektörü ESG zorunlu ek bölümleri:**
  1. Gıda güvenliği ve ürün geri çekme riski (özel marka %54 ile kritik seviye)
  2. Tedarik zinciri çocuk işçiliği / emek hakları
  3. Plastik ambalaj azaltma hedefi (EU talebi)
  4. Gıda israfı oranı (hard-discount modelinde son kullanma tarihi yönetimi)
  5. Mağaza enerji verimliliği (14.000 mağaza x enerji/m2)
- **CEO dualitesi G skorunu düşürmeli** — Topbaş hem YK Başkanı hem interim CEO = SPK best practice ihlali. Bu yapı sürdüğü sürece G 6.5'ten 5.5'e düşürülmeli.
- **BIMAS ESG referans değerleri (Nisan 2026):** Genel puan 6.0/10 (E:6.0, S:5.5, G:6.5). BIST Sürdürülebilirlik Endeksi 2023'ten üye. FTSE4Good dahil. Peer gap: Carrefour 7.3 / JMart 7.0 / BIMAS 6.0.

## CEO Geri Bildirimi — 2026-04-14 — KCHOL Delta Raporu

### Eksikler:
- **BIST Sürdürülebilirlik Endeksi doğrulanamadı** — "[DOĞRULANAMADI]" ile bırakıldı. Kural: "bulunamadı demeden 5 adım tüket."
- **CDP kaydı aranmadı** — cdp.net'te "Koç Holding" araması yapılmadı.
- **MSCI/Sustainalytics verileri "%0"** — Premium veri gerektiriyor; ama sector benchmark proxy bile verilmedi.
- **TSRS uyum durumu kontrol edilmedi** — KAP'ta TFRS-S1/S2 uyum beyanı aranmadı.
- **Holding için ESG aggregation metodolojisi açıklanmadı** — TUPRS + YKBNK + ARCLK farklı sektörler. Ağırlıklı ortalama nasıl hesaplandı?
- **YK bağımsızlık oranı %36.4 tek kaynak** — Faaliyet raporu PDF çekilmedi; bu değer tahmini mi, resmi mi belirsiz.

### Bundan Sonra:
- **Holding ESG'de 3 katman** — (1) Holding-level governance, (2) En büyük 3 subsidiary'nin ESG profili, (3) Portföy ağırlıklı ESG skoru.
- **KCHOL için CDP kaydı doğrulama adımı** — cdp.net'te araması zorunlu; TUPRS'in CDP kaydı ayrıca alınmalı.
- **BIST Sürdürülebilirlik üyeliği teyit adımı** — bist.com.tr/endeksler → Sürdürülebilirlik → Bileşen listesi PDF.

## CEO Geri Bildirimi — 2026-04-14 — SAHOL Raporu

### Eksikler:
- **Holding-level Scope 1/2/3 raporu çekilmedi** — CDP kayıt durumu ve Holding konsolide karbon ayak izi bilinmiyor.
- **BIST Sürdürülebilirlik Endeksi mevcut durumu TBD bırakıldı**
...
- **Yönetişim skoru 4.5/10 — gerekçe yetersiz**

### Bundan Sonra:
- **CDP kayıt araştırması ZORUNLU:** cdp.net'te şirket ara; "Bilinmiyor" YASAK.
...
- **G skoru için YK tablosu ZORUNLU:** Bağımsız üye sayısı / toplam, denetim komitesi yapısı, aile üyesi yoğunluğu.

## Son 3 Raporun Ogrenimleri

- **EREGL (2026-04-13):** TSRS teyidi somut olarak var (IR sayfasinda). BIST Surdurulebilirlik uyeligi Kasim 2015'ten beri. CBAM risk seviyesi 3/5. Net-zero hedefi: 2.2 tCO2/TCS, 2030 -%25, 2050 net zero. ISG: Injury Freq Rate 5.99. Kadin calisan %6.7. Su geri dolasim %90.7. Atik geri kazanim 970,902 ton.
